...
class accelerationSensor_e(IntEnum):
...
class adjustmentFunction_e(IntEnum):
...
class adjustmentMode_e(IntEnum):
    """From inav/src/main/fc/rc_adjustments.h"""
...
class afatfsAppendFreeClusterPhase_e(IntEnum):
...
class afatfsAppendSuperclusterPhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsCacheBlockState_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsClusterSearchCondition_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsDeleteFilePhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsExtendSubdirectoryPhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsFATPattern_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsFileOperation_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsFreeSpaceSearchPhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsInitializationPhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
    ...
    AFATFS_INITIALIZATION_FREEFILE_LAST = 6
    AFATFS_INITIALIZATION_DONE = 7


class afatfsOperationStatus_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.h"""
...
class afatfsSaveDirectoryEntryMode_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class afatfsTruncateFilePhase_e(IntEnum):
    """From inav/src/main/io/asyncfatfs/asyncfatfs.c"""
...
class airmodeHandlingType_e(IntEnum):
...
class biquadFilterType_e(IntEnum):
...
class blackboxBufferReserveStatus_e(IntEnum):
    """From inav/src/main/blackbox/blackbox_io.h"""
...
class bootLogEventCode_e(IntEnum):
...
class climbRateToAltitudeControllerMode_e(IntEnum):
...
class colorComponent_e(IntEnum):
...
class crsfActiveAntenna_e(IntEnum):
...
class devHardwareType_e(IntEnum):
    """From inav/src/main/drivers/bus.h"""
...
class dronecanAsyncState_e(IntEnum):
...
class dronecanBitrate_e(IntEnum):
    """From inav/src/main/drivers/dronecan/dronecan.h"""
...
class emergLandState_e(IntEnum):
...
class escSensorFrameStatus_t(IntEnum):
...
class escSensorState_t(IntEnum):
    """From inav/src/main/sensors/esc_sensor.c"""
...
class failsafeChannelBehavior_e(IntEnum):
...
class failsafeProcedure_e(IntEnum):
    """From inav/src/main/flight/failsafe.h"""
...
class failsafeRxLinkState_e(IntEnum):
    """From inav/src/main/flight/failsafe.h"""
...
class fatFilesystemType_e(IntEnum):
...
class fixedWingLaunchEvent_t(IntEnum):
...
class fixedWingLaunchMessage_t(IntEnum):
    """From inav/src/main/navigation/navigation_fw_launch.c"""
...
class fixedWingLaunchState_t(IntEnum):
    """From inav/src/main/navigation/navigation_fw_launch.c"""
...
class flashPartitionType_e(IntEnum):
...
class fport2_control_frame_type_e(IntEnum):
...
class fwAutolandState_t(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class fwAutolandWaypoint_t(IntEnum):
    """From inav/src/main/navigation/navigation_private.h"""
...
class geoAltitudeDatumFlag_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class geoOriginResetMode_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class geozoneActionState_e(IntEnum):
...
class geozoneMessageState_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class ghstFrameTypeIndex_e(IntEnum):
...
class gimbalHeadtrackerState_e(IntEnum):
...
class gyroHardwareLpf_e(IntEnum):
...
class headTrackerDevType_e(IntEnum):
...
class hsvColorComponent_e(IntEnum):
    """From inav/src/main/common/color.h"""
...
class i2cTransferDirection_t(IntEnum):
    """From inav/src/main/drivers/bus_i2c_stm32f40x.c"""
...
class ibusSensorType1_e(IntEnum):
...
class ibusSensorType_e(IntEnum):
    """From inav/src/main/telemetry/ibus_shared.h"""
...
class ibusSensorValue_e(IntEnum):
    """From inav/src/main/telemetry/ibus_shared.h"""
...
class icm42605Variant_e(IntEnum):
...
class ledBaseFunctionId_e(IntEnum):
    """From inav/src/main/io/ledstrip.h"""
...
class ledDirectionId_e(IntEnum):
    """From inav/src/main/io/ledstrip.h"""
...
class ledSpecialColorIds_e(IntEnum):
    """From inav/src/main/io/ledstrip.h"""
...
class logicFlightOperands_e(IntEnum):
    """From inav/src/main/programming/logic_condition.h"""
...
class logicOperandType_e(IntEnum):
    """From inav/src/main/programming/logic_condition.h"""
...
class logicOperation_e(IntEnum):
    """From inav/src/main/programming/logic_condition.h"""
...
class logicWaypointOperands_e(IntEnum):
    """From inav/src/main/programming/logic_condition.h"""
...
class mavlinkAutopilotType_e(IntEnum):
    """From inav/src/main/telemetry/telemetry.h"""
...
class mavlinkFcDispatchResult_e(IntEnum):
...
class measurementSteps_e(IntEnum):
...
class mixerProfileATDirection_e(IntEnum):
...
class mixerProfileATOsdEvent_e(IntEnum):
    """From inav/src/main/flight/mixer_profile.h"""
...
class mixerProfileATRequest_e(IntEnum):
    """From inav/src/main/flight/mixer_profile.h"""

    MIXERAT_REQUEST_NONE = 0
    MIXERAT_REQUEST_RTH = 1
    MIXERAT_REQUEST_LAND = 2
    MIXERAT_REQUEST_MISSION_TO_FW = 3
    MIXERAT_REQUEST_MISSION_TO_MC = 4
    MIXERAT_REQUEST_MANUAL_TO_FW = 5
    MIXERAT_REQUEST_MANUAL_TO_MC = 6
    MIXERAT_REQUEST_FW_TO_MC_PROTECTION = 7
    MIXERAT_REQUEST_ABORT = 8


class mixerProfileATState_e(IntEnum):
    """From inav/src/main/flight/mixer_profile.h"""
...
class mixerProfileATWaitReason_e(IntEnum):
    """From inav/src/main/flight/mixer_profile.h"""
...
class mixerTransitionManualSessionMode_e(IntEnum):
...
class modeActivationOperator_e(IntEnum):
    """From inav/src/main/fc/rc_modes.h"""
...
class motorPwmProtocolTypes_e(IntEnum):
...
class mpu9250CompassReadState_e(IntEnum):
...
class mspFlashfsFlags_e(IntEnum):
...
class mspPassthroughType_e(IntEnum):
    """From inav/src/main/fc/fc_msp.c"""
...
class mspSDCardFlags_e(IntEnum):
    """From inav/src/main/fc/fc_msp.c"""

    MSP_SDCARD_FLAG_SUPPORTTED = 1


class mspSDCardState_e(IntEnum):
    """From inav/src/main/fc/fc_msp.c"""
...
class nav_heading_control_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class nav_loiter_type_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class nav_reset_type_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class nav_rth_alt_profile_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class nav_rth_climb_profile_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class navigationFSMEvent_t(IntEnum):
    """From inav/src/main/navigation/navigation_private.h"""
    ...
    NAV_FSM_EVENT_MIXERAT_MISSION_ADVANCE = 18
    NAV_FSM_EVENT_MIXERAT_MISSION_CAPTURE = 19
...
class navigationHomeFlags_t(IntEnum):
    """From inav/src/main/navigation/navigation_private.h"""
...
class navigationPersistentId_e(IntEnum):
    """From inav/src/main/navigation/navigation_private.h"""
...
class oledControllerType_e(IntEnum):
...
class opticalFlowSensor_e(IntEnum):
    """From inav/src/main/sensors/opflow.h"""
...
class osd_crosshairs_style_e(IntEnum):
    """From inav/src/main/io/osd.h"""
...
class osd_crsf_lq_format_e(IntEnum):
    """From inav/src/main/io/osd.h"""
...
class osd_sidebar_arrow_e(IntEnum):
...
class osd_sidebar_scroll_e(IntEnum):
    """From inav/src/main/io/osd.h"""
...
class persistentObjectId_e(IntEnum):
...
class pidAutotuneState_e(IntEnum):
...
class rcdevice_camera_control_opeation_e(IntEnum):
    """From inav/src/main/io/rcdevice.h"""
...
class reversibleMotorsThrottleState_e(IntEnum):
    """From inav/src/main/flight/mixer.h"""
...
class rollPitchStatus_e(IntEnum):
    """From inav/src/main/fc/rc_controls.h"""
...
class rthTrackbackMode_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class rxSerialReceiverType_e(IntEnum):
    """From inav/src/main/rx/rx.h"""
...
class sbusDecoderState_e(IntEnum):
...
class sdcardBlockOperation_e(IntEnum):
...
class sdcardOperationStatus_e(IntEnum):
    """From inav/src/main/drivers/sdcard/sdcard.h"""
...
class sdcardReceiveBlockStatus_e(IntEnum):
...
class sensorTempCalState_e(IntEnum):
    """From inav/src/main/sensors/sensors.h"""
...
class servoAutotrimState_e(IntEnum):
...
class servoProtocolType_e(IntEnum):
    """From inav/src/main/drivers/pwm_mapping.h"""
...
class simModuleState_e(IntEnum):
    """From inav/src/main/telemetry/sim.c"""
...
class simTelemetryState_e(IntEnum):
    """From inav/src/main/telemetry/sim.c"""
...
class simTransmissionState_e(IntEnum):
    """From inav/src/main/telemetry/sim.c"""
...
class smartAudioVersion_e(IntEnum):
...
class smartportFuelUnit_e(IntEnum):
    """From inav/src/main/telemetry/telemetry.h"""
...
class softSerialPortIndex_e(IntEnum):
...
class tempSensorType_e(IntEnum):
...
class tz_automatic_dst_e(IntEnum):
...
class ublox_nav_sig_quality(IntEnum):
    """From inav/src/main/io/gps_ublox.h"""
...
class ubs_nav_fix_type_t(IntEnum):
    """From inav/src/main/io/gps_ublox.h"""
...
class ubx_nav_status_bits_t(IntEnum):
    """From inav/src/main/io/gps_ublox.h"""

    NAV_STATUS_FIX_VALID = 1


class ubx_protocol_bytes_t(IntEnum):
    """From inav/src/main/io/gps_ublox.h"""
...
class vcselPeriodType_e(IntEnum):
    """From inav/src/main/drivers/rangefinder/rangefinder_vl53l0x.c"""
...
class vtxFrequencyGroups_e(IntEnum):
    """From inav/src/main/drivers/vtx_common.h"""
...
class vtxLowerPowerDisarm_e(IntEnum):
...
class vtxProtoResponseType_e(IntEnum):
...
class vtxScheduleParams_e(IntEnum):
...
class warningLedState_e(IntEnum):
...
class wpMissionPlannerStatus_e(IntEnum):
    """From inav/src/main/navigation/navigation.h"""
...
class zeroCalibrationState_e(IntEnum):
