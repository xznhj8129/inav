# INAV enums (MSP reference)

Harvested from INAV C source into `msp/schema/enums.yaml` by `msp/generator/harvest_enums.py`; rendered by `gen_docs.py`. Do not edit by hand.
...
| `ADCDEV_MAX` | 0 | NOT(STM32F4 || STM32F7 || STM32H7) |
| `ADCDEV_COUNT` | 1 | |
...
| `AFATFS_INITIALIZATION_FREEFILE_LAST` | 6 | AFATFS_USE_FREEFILE |
...
---
## `beeperMode_e`
> From inav/src/main/io/beeper.h
...
---
## `biquadFilterType_e`
> From inav/src/main/common/filter.h
...
---
## `bmi270Register_e`
> From inav/src/main/drivers/accgyro/accgyro_bmi270.c
...
---
## `boxId_e`
> From inav/src/main/fc/rc_modes.h
...
---
## `colorComponent_e`
> From inav/src/main/common/color.h
...
> From inav/src/main/drivers/dronecan/dronecan.h
...
> From inav/src/main/sensors/esc_sensor.c
...
---
## `exBusHeader_e`
> From inav/src/main/rx/jetiexbus.h
...
---
## `exDataType_e`
> From inav/src/main/telemetry/jetiexbus.c
...
> From inav/src/main/flight/failsafe.c
...
---
## `failureMode_e`
> From inav/src/main/drivers/system.h
...
---
## `fatFilesystemType_e`
> From inav/src/main/io/asyncfatfs/fat_standard.h
...
> From inav/src/main/navigation/navigation_fw_launch.c
...
> From inav/src/main/drivers/flash.h
...
> From inav/src/main/rx/fport2.c
...
> From inav/src/main/navigation/navigation_geozone.c
...
---
## `ghstAddr_e`
> From inav/src/main/rx/ghst_protocol.h
...
> From inav/src/main/telemetry/ghst.c

| Member | Value | Condition |
|---|---:|---|
| `GHST_FRAME_START_INDEX` | 0 | |
| `GHST_FRAME_PACK_INDEX` | 0 | |
...
> From inav/src/main/io/gimbal_serial.h
...
| Member | Value | Condition |
|---|---:|---|
| `GPS_FIX_CHAR_NONE` | 45 | |
| `GPS_FIX_CHAR_2D` | 50 | |
| `GPS_FIX_CHAR_3D` | 51 | |
| `GPS_FIX_CHAR_DGPS` | 68 | |
...
---
## `gpsState_e`
> From inav/src/main/io/gps_private.h
...
> From inav/src/main/drivers/headtracker_common.h
...
---
## `i2cState_t`
> From inav/src/main/drivers/bus_i2c_stm32f40x.c
...
---
## `ibusCommand_e`
> From inav/src/main/telemetry/ibus_shared.c
...
---
## `ibusSensorType1_e`
> From inav/src/main/telemetry/ibus_shared.h
...
---
## `icm42605Variant_e`
> From inav/src/main/drivers/accgyro/accgyro_icm42605.c
...
| `LOGIC_CONDITION_GLOBAL_FLAG_DISABLE_GPS_FIX` | 2048 | USE_GPS_FIX_ESTIMATION |
...
---
## `ltm_frame_e`
> From inav/src/main/telemetry/ltm.h
...
| `LTM_AFRAME` | 0 | |
| `LTM_SFRAME` | 1 | |
| `LTM_GFRAME` | 2 | USE_GPS |
| `LTM_OFRAME` | 3 | USE_GPS |
| `LTM_XFRAME` | 4 | USE_GPS |
| `LTM_NFRAME` | 5 | |
| `LTM_FRAME_COUNT` | 6 | |
...
> From inav/src/main/fc/fc_mavlink.h
...
---
## `measurementSteps_e`
> From inav/src/main/drivers/rangefinder/rangefinder_vl53l0x.c
...
> From inav/src/main/flight/mixer_profile.h
...
> From inav/src/main/flight/mixer_transition_logic.h
...
> From inav/src/main/drivers/compass/compass_mpu9250.c
...
| `NAV_FSM_EVENT_SWITCH_TO_NAV_STATE_FW_LANDING_ABORT` | 18 | |
| `NAV_FSM_EVENT_SWITCH_TO_NAV_STATE_FW_LANDING_FINISHED` | 19 | |
| `NAV_FSM_EVENT_SWITCH_TO_WAYPOINT_HOLD_TIME` | 18 | |
| `NAV_FSM_EVENT_SWITCH_TO_WAYPOINT_RTH_LAND` | 19 | |
| `NAV_FSM_EVENT_SWITCH_TO_WAYPOINT_FINISHED` | 20 | |
| `NAV_FSM_EVENT_SWITCH_TO_WAYPOINT_JUMP` | 21 | |
| `NAV_FSM_EVENT_SWITCH_TO_NAV_STATE_RTH_INITIALIZE` | 18 | |
| `NAV_FSM_EVENT_SWITCH_TO_NAV_STATE_RTH_TRACKBACK` | 19 | |
| `NAV_FSM_EVENT_SWITCH_TO_RTH_HEAD_HOME` | 20 | |
| `NAV_FSM_EVENT_SWITCH_TO_RTH_LOITER_ABOVE_HOME` | 21 | |
| `NAV_FSM_EVENT_MIXERAT_MISSION_ADVANCE` | 18 | USE_AUTO_TRANSITION |
| `NAV_FSM_EVENT_MIXERAT_MISSION_CAPTURE` | 19 | USE_AUTO_TRANSITION |
| `NAV_FSM_EVENT_SWITCH_TO_RTH_LANDING` | 22 | |
| `NAV_FSM_EVENT_MIXERAT_MISSION_RESUME` | 23 | USE_AUTO_TRANSITION |
...
| `NAV_HOME_VALID_XY` | 1 | |
| `NAV_HOME_VALID_Z` | 2 | |
| `NAV_HOME_VALID_HEADING` | 4 | |
| `NAV_HOME_VALID_ALL` | 7 | |
...
> From inav/src/main/drivers/display_ug2864hsweg01.c
...
---
## `osd_sidebar_arrow_e`
> From inav/src/main/io/osd_grid.c
...
---
## `pageId_e`
> From inav/src/main/io/dashboard.h
...
> From inav/src/main/drivers/persistent.h
...
---
## `pidAutotuneState_e`
> From inav/src/main/flight/pid_autotune.c
...
---
## `pollType_e`
> From inav/src/main/io/smartport_master.c
...
| `QUADRANT_EAST` | 4 | |
| `QUADRANT_WEST` | 8 | |
| `QUADRANT_NORTH_EAST` | 16 | |
| `QUADRANT_SOUTH_EAST` | 32 | |
| `QUADRANT_NORTH_WEST` | 64 | |
| `QUADRANT_SOUTH_WEST` | 128 | |
| `QUADRANT_NONE` | 256 | |
...
---
## `rcc_reg`
> From inav/src/main/drivers/rcc.h
...
---
## `resolutionType_e`
> From inav/src/main/io/displayport_msp_osd.c
...
---
## `resourceOwner_e`
> From inav/src/main/drivers/resource.h
...
> From inav/src/main/drivers/sdcard/sdcard.h
...
> From inav/src/main/drivers/sdcard/sdcard_spi.c
...
---
## `sdcardState_e`
> From inav/src/main/drivers/sdcard/sdcard_impl.h
...
> From inav/src/main/flight/servos.c
...
---
## `sliceAssign_e`
> From inav/src/main/drivers/pwm_output_rp2350.c
...
---
## `smartAudioVersion_e`
> From inav/src/main/io/vtx_smartaudio.h
...
> From inav/src/main/drivers/serial_softserial.h
...
| `GPS_ESTIMATED_FIX` | 1024 | USE_GPS_FIX_ESTIMATION |
...
---
## `tristate_e`
> From inav/src/main/common/tristate.h
...
---
## `tz_automatic_dst_e`
> From inav/src/main/common/time.h
...
> From inav/src/main/io/gps_ublox.h
...
| `VOLTAGE_SENSOR_MAX` | 7 | |

---
## `vs600Band_e`
> From inav/src/main/io/smartport_master.h
...
> From inav/src/main/io/vtx_tramp.c
...
---
## `warningLedState_e`
> From inav/src/main/io/statusindicator.c
...
> From inav/src/main/common/calibration.h
